...
void jendela() {
    glColor3d(0.15, 0.19, 0.19);
    glutSolidCube(10);

    glColor3d(0.26, 0.26, 0.97);
    glPushMatrix();
...
void kasur() {
    ...
    glPushMatrix();
    glTranslated(-40.0, -2.0, 9);
    glScaled(1.0, 0.5, 1.6);
    glutSolidCube(10);
    glPopMatrix();
...
void figure() {
    ...
    //figura kecil atas kasur
    glPushMatrix();
    glTranslated(3.20, 38.0, -96.0);
    glScaled(0.72, -0.53, -0.45);
    figure3();
    glPopMatrix();

    glPushMatrix();
    glTranslated(12.0, 38.0, -96.0);
    glScaled(0.49, -0.53, -0.45);
    figure3();
    glPopMatrix();

    glPushMatrix();
    glTranslated(-19.0, 38.0, -96.0);
    glScaled(0.49, -0.53, -0.45);
    figure3();
    glPopMatrix();

    //figura kecil atas kiri
    glPushMatrix();
    glTranslated(-35.20, 55.0, -96.0);
    glScaled(0.49, -0.53, -0.45);
    figure3();
    glPopMatrix();

    glPushMatrix();
    glTranslated(-35.20, 68.0, -96.0);
    glScaled(0.49, -0.53, -0.45);
    figure3();
    glPopMatrix();

    //figura kecil atas kanan
    glPushMatrix();
    glTranslated(65.20, 55.0, -96.0);
    glScaled(0.49, -0.53, -0.45);
    figure3();
    glPopMatrix();

    glPushMatrix();
    glTranslated(65.20, 68.0, -96.0);
    glScaled(0.49, -0.53, -0.45);
    figure3();
    glPopMatrix();

    glPushMatrix();
    glTranslated(65.20, 42.0, -96.0);
    glScaled(0.49, -0.53, -0.45);
    figure3();
    glPopMatrix();
